...
public class SingleLinkedListImpl<T> extends AbstractSingleLinkedListImpl<T> {
	...
	public AbstractSingleLinkedListImpl<T> reverse() {
		AbstractSingleLinkedListImpl<T> inversa = new SingleLinkedListImpl<T>(null);
	...
	public int isSubList(AbstractSingleLinkedListImpl<T> part) {
		int pos;
		pos=isSubListRec( part);
		return size()-pos;
	}
	public int isSubListRec(AbstractSingleLinkedListImpl<T> part) {
		return 0;
